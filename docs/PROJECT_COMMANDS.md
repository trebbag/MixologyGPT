...
- Alerting operations:
  ...
  - Full all-six pilot continuation (real signoff + web/mobile staging E2E + compliance smoke): `cd /Users/gregorygabbert/Documents/GitHub/BartenderAI && API_BASE_URL=https://<staging-host> INTERNAL_TOKEN=<token> STAGING_E2E_ACCESS_TOKEN=<token> ./infra/staging/pilot_all_six.sh`
