# Load Gate Evaluation (staging_signed_2026-02-13)

- Stats file: `infra/loadtest/results/staging_signed_2026-02-13_stats.csv`
...
| `studio_generate_p95_ms` | `13.0000` | `1000` | `PASS` |
| `aggregate_p95_ms` | `17.0000` | `1500` | `PASS` |
