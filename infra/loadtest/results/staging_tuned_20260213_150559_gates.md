# Load Gate Evaluation (staging_tuned_20260213_150559)

- Stats file: `infra/loadtest/results/staging_tuned_20260213_150559_stats.csv`
- Gates file: `infra/loadtest/gates.pilot.locked.json`
- Total requests: `14764`
- Total failures: `0`
- Overall result: `PASS`
...
| `studio_generate_p95_ms` | `14.0000` | `600` | `PASS` |
