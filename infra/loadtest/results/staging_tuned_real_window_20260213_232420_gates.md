# Load Gate Evaluation (staging_tuned_real_window_20260213_232420)

- Stats file: `infra/loadtest/results/staging_tuned_real_window_20260213_232420_stats.csv`
...
| `studio_generate_p95_ms` | `22.0000` | `600` | `PASS` |
| `aggregate_p95_ms` | `26.0000` | `900` | `PASS` |
