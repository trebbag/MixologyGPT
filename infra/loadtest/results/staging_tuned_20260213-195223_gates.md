# Load Gate Evaluation (staging_tuned_20260213-195223)

- Stats file: `infra/loadtest/results/staging_tuned_20260213-195223_stats.csv`
...
| `aggregate_p95_ms` | `32.0000` | `900` | `PASS` |
