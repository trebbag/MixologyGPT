# Load Gate Evaluation (staging-second-pass-local)

- Stats file: `infra/loadtest/results/staging-second-pass-local_stats.csv`
...
| `studio_generate_p95_ms` | `36.0000` | `1000` | `PASS` |
