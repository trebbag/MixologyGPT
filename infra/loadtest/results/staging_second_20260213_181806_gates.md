# Load Gate Evaluation (staging_second_20260213_181806)

- Stats file: `infra/loadtest/results/staging_second_20260213_181806_stats.csv`
- Gates file: `infra/loadtest/gates.pilot.locked.json`
- Total requests: `14679`
- Total failures: `0`
- Overall result: `PASS`
...
| `studio_generate_p95_ms` | `23.0000` | `600` | `PASS` |
