# Load Gate Evaluation (pilot_local_real_window_locked_20260214)

- Stats file: `infra/loadtest/results/pilot_local_real_window_locked_20260214_stats.csv`
- Gates file: `infra/loadtest/gates.pilot.locked.json`
- Total requests: `14600`
- Total failures: `0`
- Overall result: `PASS`
...
| `search_p95_ms` | `76.0000` | `700` | `PASS` |
| `studio_generate_p95_ms` | `25.0000` | `600` | `PASS` |
| `aggregate_p95_ms` | `44.0000` | `900` | `PASS` |
